...
<p align="center"><b>TFT In-Cell 模组 · MIPI · AXS15231E · 多版本索引</b></p>
...
本仓库收录 **3.5 寸 320×480 TFT（MIPI · AXS15231E）** 显示模组资料。
...
| 版本 | 宣传图 | 简介 | 完整资料 |
| ---- | ------ | ---- | -------- |
| YDP350TE011-V1 | — | [简介](#ydp350te011-v1) | [完整资料](./versions/YDP350TE011-V1/) |

---

## YDP350TE011-V1

**说明：** FPC 为 30 Pin，In-Cell 电容触摸（I2C；规格书未标明具体 IC；TP_RESET 为 NC）。

完整产品页、规格书与示例：[versions/YDP350TE011-V1/](./versions/YDP350TE011-V1/)
